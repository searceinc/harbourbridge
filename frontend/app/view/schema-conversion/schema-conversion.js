...
const initSchemaScreenTasks = () => {
  ...
  jQuery(document).ready(() => {
    ...
    jQuery('.collapse.inner-summary-collapse').on('show.bs.collapse', function (e) {
      if (!jQuery(this).closest('section').hasClass('template')) {
        e.stopPropagation();
      }
    });
    jQuery('.collapse.inner-summary-collapse').on('hide.bs.collapse', function (e) {
      if (!jQuery(this).closest('section').hasClass('template')) {
        e.stopPropagation();
      }
    });
 ...
 */
const schemaReport = () => {
  jQuery('#app').load('app/view/schema-conversion/schema-conversion-screen.html');
}
